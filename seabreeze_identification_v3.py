...
if __name__ == '__main__':
    ...
    stats_output_path = "/g/data/up6/cx5009/hackathon/energy2026/Data_identified_seabreeze/time_part/" # need change
    ...
    exp_season = os.environ["EXP_SEASON"]
    exp_res = os.environ["EXP_RES"]
    exp_id = os.environ["EXP_ID"]

    t1 = os.environ["T1"]
    t2 = os.environ["T2"]
    change_tlocal = os.environ["LOCT"]

    time_part = os.environ["TIME_PART"]
    ...
    outdir = Path(
        f"/g/data/up6/cx5009/hackathon/energy2026/Data_identified_seabreeze/time_part/{exp_season}_{exp_res}_{exp_id}_{time_part}"
    )
    ...
    F_objects = sea_breeze_filters.filter_3d(
        ...
        skipna=False,
        props_df_out_path=stats_output_path + f"F_{exp_season}_{exp_res}_{exp_id}_{time_part}.csv",
        **kwargs).compute()
