...
sys.path.append('/g/data/k10/ds1182/seabreeze_work/GC26_sydney_wind') # need change
...
stats_output_path = "/g/data/k10/ds1182/seabreeze_work/GC26_sydney_wind/" # need change
...
outdir = Path(
    f"/g/data/k10/ds1182/seabreeze_work/GC26_sydney_wind//{exp_season}_{exp_res}_{exp_id}"
)
...
angle_ds = xr.open_dataset(f'/g/data/k10/ds1182/seabreeze_work/GC26_sydney_wind/coast_angle_{exp_res}.nc') # need change
