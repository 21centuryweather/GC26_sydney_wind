...
sys.path.append('/g/data/k10/ds1182/') # need change
client = Client()
...
stats_output_path = "/g/data/k10/ds1182/seabreeze_work/" # need change
...
angle_ds = xr.open_dataset(f'/g/data/k10/ds1182/seabreeze_work/coast_angle_{exp_res}.nc') # need change
